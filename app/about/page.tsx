  ...
  return (
    <div>
      ...
      <Card className="max-w-[500px]">
        ...
        <CardBody>
          <div className="m-y-2">
            <Code color="default" size="md">
              <b>Hello, I'm Drowzee! 👋 </b>
            </Code>
          </div>
          <div>
            <Code
              className="whitespace-pre-wrap text-wrap break-words text-sm "
              color="default"
              size="sm"
            >
              <p>
                I'm a 17 year-old programmer and Computer Science major at the
                University of Maryland! Some of my favorite activities are
                fencing, hanging out with my friends,{" "}
                <Link className="text-sm" href="/projects">
                  coding
                </Link>
                , reading, and most importantly, playing with my guinea pigs.
              </p>
              <br />
                ...
                <CCarousel controls indicators interval={false}>
                  ...
                  <CCarouselItem>
                    <CImage
                      alt="slide 5"
                      className="d-block w-full object-cover rounded"
                      src={"/carousel/piggy/5.png"}
                    />
                  </CCarouselItem>
                </CCarousel>
              </div>

              <p className="text-default-400 text-xs text-center m-2">
                Oh they're so adorable :)
              </p>

              <p>
                At the age of 13, I picked up programming as a hobby and
                self-taught my first language, Node JS. Since then, I have
                branched out to multiple adventures, even publishing{" "}
                <Link
                  isExternal
                  className="text-sm"
                ...
                with the National High School Game Academy at Carnegie Mellon
                University.
              </p>
              <br />
              <p>
                ...
                if you want to know anything about my projects, life, or any
                other pressing questions you may have, or if you just want to
                say hi!
              </p>
              <Accordion>
                <AccordionItem
                  key="1"
                  aria-label="Here's some people that inspire me"
                  title="Here's some people that inspire me"
                >
                  <div className="">
                        ...
                        <TableRow key="1">
                          ...
                          <TableCell>
                            <Link
                              isExternal
                              className="text-sm"
                              href="https://en.wikipedia.org/wiki/Jim_Sinclair_(activist)"
                            >
                              Here
                            </Link>
                          </TableCell>
                ...
                <AccordionItem
                  key="2"
                  aria-label="Some of my favorite pieces of media are"
                  title="Some of my favorite pieces of media are"
                >
                      ...
                      <TableRow key="1">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://en.wikipedia.org/wiki/Link_Click"
                          >
                            Here
                          </Link>
                        </TableCell>
                      ...
                      <TableRow key="2">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://philosophy.ucsc.edu/SinclairDontMournForUs.pdf"
                          >
                            Here
                          </Link>
                        </TableCell>
                      ...
                      <TableRow key="3">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://www.goodreads.com/book/show/56783258-cloud-cuckoo-land"
                          >
                            Here
                          </Link>
                        </TableCell>
                      ...
                      <TableRow key="5">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://glassbeach.bandcamp.com/album/the-first-glass-beach-album"
                          >
                            Here
                          </Link>
                        </TableCell>
                      ...
                      <TableRow key="6">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://classicj.bandcamp.com/album/hes-not-with-us-anymore"
                          >
                            Here
                          </Link>
                        </TableCell>
                      ...
                      <TableRow key="7">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://marcioz.bandcamp.com/album/how-to-make-love-tay"
                          >
                            Here
                          </Link>
                        </TableCell>
                      ...
                      <TableRow key="8">
                        ...
                        <TableCell>
                          <Link
                            isExternal
                            className="text-sm"
                            href="https://glassbeach.bandcamp.com/album/plastic-death"
                          >
                            Here
                          </Link>
                        </TableCell>
        ...
        <CardFooter className="text-center flex flex-col">
          ...
          <div className="flex flex-row m-2 gap-2 justify-center">
            <a download href="/resume.pdf">
              <Button variant="shadow">My Résumé</Button>
            </a>
          </div>
        </CardFooter>
      </Card>
